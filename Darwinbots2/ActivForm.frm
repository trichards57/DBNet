...
Private Sub DrawStat(ga() As Boolean)
  ...
  For t = 1 To gn
    ...
    Else
      FillColor = vbRed
    End If
    Line (cornice.Left + stp * (t - 1), cornice.Top)-(cornice.Left + stp * (t), cornice.Top + cornice.Height), , B
  Next
End Sub
...
Private Sub DrawDyn(ga() As Boolean)
  ...
  For t = 1 To gn
    ...
    FillColor = vbBlue
    Line (cornice2.Left + stp * (t - 1), cornice2.Top)-(cornice2.Left + stp * (t), cornice2.Top + ReH), , B
    FillColor = vbCyan
    Line (cornice2.Left + stp * (t - 1), cornice2.Top + ReH)-(cornice2.Left + stp * (t), cornice2.Top + ReH + GrH), , B
  Next
End Sub
