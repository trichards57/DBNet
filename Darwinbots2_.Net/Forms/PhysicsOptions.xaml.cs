...
namespace DBNet.Forms
{
    public partial class PhysicsOptions : Window
    {
        ...
        public static PhysicsOptions instance { set { _instance = null; } get { return _instance ?? (_instance = new PhysicsOptions()); } }

        public static void Load()
        {
            if (_instance == null) { dynamic A = PhysicsOptions.instance; }
        }
        ...
        private void Command_Click(int Index)
        {
            switch (Index)
            {
        ...
        private void FluidText_Change(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            FluidText_Change();
        }

        private void FluidText_Change(int Index)
        {
        ...
        private void FluidText_GotFocus(object sender, RoutedEventArgs e)
        {
            FluidText_GotFocus();
        }

        private void FluidText_GotFocus(int Index)
        {
            switch (Index)
            {
                case 0:  //viscosity
        ...
        private void FluidText_LostFocus(object sender, RoutedEventArgs e)
        {
            FluidText_LostFocus();
        }

        private void FluidText_LostFocus(int Index)
        {
        ...
        private void Friction_Change(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            Friction_Change();
        }

        private void Friction_Change(int Index)
        {
            switch (Index)
            {
                case 0:
        ...
        private void Friction_GotFocus(object sender, RoutedEventArgs e)
        {
            Friction_GotFocus();
        }

        private void Friction_GotFocus(int Index)
        {
            switch (Index)
            {
        ...
        private void Friction_Scroll(int Index)
        {
            Friction_Change((Index));
        }

        private void MiscSlider_Change(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            MiscSlider_Change();
        }

        private void MiscSlider_Change(int Index)
        {
            switch (Index)
            {
        ...
        private void MiscSlider_GotFocus(object sender, RoutedEventArgs e)
        {
            MiscSlider_GotFocus();
        }

        private void MiscSlider_GotFocus(int Index)
        {
            switch (Index)
            {
                case 0:  //bang efficiency
        ...
        private void MiscSlider_Scroll(int Index)
        {
            MiscSlider_Change((Index));
        }

        private void PlanetEatersText_Change(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            PlanetEatersText_Change();
        }
        ...
        private void Toggles_Click(object sender, RoutedEventArgs e)
        {
            Toggles_Click();
        }

        private void Toggles_Click(int Index)
        {
            switch (Index)
            {
                case 0:
